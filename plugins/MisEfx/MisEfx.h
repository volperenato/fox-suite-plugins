...
class Feedverb : public AudioEffectX {
	...
	float fdnver_mix;
	float _wet, _dry;
	float fdnver_modRate;
	float fdnver_modDepth;
	float fdnver_highfreq;
	float fdnver_roomSize;
	float fdnver_modFeed;
	float fdnver_modMix;
	float fdnver_decay;
	float fdnver_spread;
	float fdnver_freqDamp;
	float fdnver_lowfreq;
	float fdnver_lpftype;
	float fdnver_stereoSpread;

	// Aux parameters
	DelayDistribution delDistrLeft;
	DelayDistribution delDistrRight;
	DiffuserDelayLogic diffLogicLeft;
	DiffuserDelayLogic diffLogicRight;
	float t;
	// FDN
	FDN* fdnver_FDN;
	Modulation* chorus;
	/*ChannelSplitter* ch;
	ChannelMixer* mx;
	MultiChannelDelay* del;
	MultiChannelDiffuser* diff;
	Hadamard* had;*/
